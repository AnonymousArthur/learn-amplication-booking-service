...
@InputType()
class BookingOrderCreateNestedManyWithoutUsersInput {
...
export { BookingOrderCreateNestedManyWithoutUsersInput as BookingOrderCreateNestedManyWithoutUsersInput };
