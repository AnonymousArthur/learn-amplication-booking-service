...
@InputType()
class BookingOrderCreateNestedManyWithoutStoreEntitiesInput {
...
export { BookingOrderCreateNestedManyWithoutStoreEntitiesInput as BookingOrderCreateNestedManyWithoutStoreEntitiesInput };
